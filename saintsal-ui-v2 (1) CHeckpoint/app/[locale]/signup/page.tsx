      ...
      >
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-gray-400 text-sm mt-2">
            Let's get you cookin' with dual AI power
          </p>
        </div>

        {/* What They're Getting */}
        <div className="mb-6 bg-gradient-to-r from-yellow-500/10 to-yellow-600/10 border border-yellow-500/20 rounded-lg p-4">
          <h3 className="text-yellow-400 font-semibold text-sm mb-2">
            🚀 You're about to get:
          </h3>
          <ul className="text-gray-300 text-xs space-y-1">
            <li>✨ Dual AI Assistant (Azure + OpenAI)</li>
            <li>🔍 Smart Lead Discovery</li>
            <li>💬 Voice & Chat Interface</li>
            <li>📊 Business Analytics</li>
            <li>🎯 Free Trial → $27 Unlimited</li>
          </ul>
        </div>
